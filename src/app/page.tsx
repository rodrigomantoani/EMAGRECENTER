            ...
            <div className="text-center md:text-left w-full order-2 md:order-1">
              ...
              <div className="mb-7 md:mb-8">
                ...
                <div className="flex items-baseline justify-center md:justify-start gap-3 mb-2">
                  <span className="text-xl sm:text-2xl text-gray-400 line-through">R$ 1.799</span>
                  <span className="text-4xl sm:text-5xl md:text-[3.5rem] font-extrabold text-gray-900">R$ 1.529</span>
                </div>
                <p className="text-sm text-green-600 font-semibold mb-3 px-4 md:px-0">✓ Economize R$ 270 comprando online</p>
                <p className="text-sm text-gray-600 px-4 md:px-0 leading-relaxed">12 semanas de tratamento (5mg/semana) • Envio liofilizado • Frete grátis</p>
              </div>
